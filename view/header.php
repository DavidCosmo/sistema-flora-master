    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light p-md-3">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav ">
            <li class="nav-item">
              <a class="nav-link font fw-bold" href="#">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font fw-bold" href="#">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font fw-bold" href="#">Blog</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font fw-bold" href="#">Pricing</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font fw-bold" href="#">Contact</a>
            </li>
          </ul>
          </div>
          <ul class="navbar-nav ">
          <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><i class='bx bx-search bag fw-bold'></i></a>
            </li>
            <li class="nav-item">
